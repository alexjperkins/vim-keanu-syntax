...
A collection of language packs for Vim. Keanu Edition by alexjperkins.

However, *ALL* credit should go to: `https://github.com/sheerun/vim-polyglot`
...
git clone https://github.com/alexjperkins/vim-keanu-syntax ~/.vim/pack/default/start/vim-polyglot
```
